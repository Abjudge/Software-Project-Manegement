...
class Task (models.Model):
    ...
    developer_id = models.ForeignKey('user.Myuser', on_delete=models.CASCADE ,related_name='developer')
    tester_id = models.ForeignKey('user.Myuser', on_delete=models.CASCADE,related_name='tester')
    owner_id = models.ForeignKey('user.Myuser', on_delete=models.CASCADE,related_name='owner')
